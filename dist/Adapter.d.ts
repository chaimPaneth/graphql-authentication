...
export interface GraphqlAuthenticationAdapter {
    ...
    findUserByEmail(ctx: Context, email: string, info?: any): Promise<User | null>;
    ...
    updateUserConfirmToken(ctx: Context, userId: ID, data: any): Promise<User | null>;
    updateUserLastLogin(ctx: Context, userId: ID, data: any): Promise<User | null>;
    updateUserPassword(ctx: Context, userId: ID, data: any): Promise<User | null>;
    updateUserResetToken(ctx: Context, userId: ID, data: any): Promise<User | null>;
    updateUserInfo(ctx: Context, userId: ID, data: any): Promise<User | null>;
    updateUserCompleteInvite(ctx: Context, userId: ID, data: any): Promise<User | null>;
}
